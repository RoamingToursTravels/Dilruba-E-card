...
function saveContact() {
    const name = 'Dilruba Sultana';
    const organization = 'Roaming Tours & Travels';
    const title = 'Visa Executive';
    const officePhone = '01332547035';
    const personalPhone = '01795793435';
    const email = 'neha.roamingbd@gmail.com';
...
function openWhatsApp() {
    const whatsappNumber = '8801332547035';
